...
from worker.face_blurring import anonymize_face_pixelate
from worker.face_blurring import anonymize_face_simple
import numpy as np 
import argparse 
import cv2 
import os 
...
net = cv2.dnn.readNet(prototxt, weightsPath)
...
# constract a blob from the image 
