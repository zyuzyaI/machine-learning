# import necasery packeges
import os

# initialize the path to the fire and non fire dataset directiries
...
# define the size of the traning and testing split
TRAIN_SPLIT = 0.75
TEST_SPLIT = 0.25
...
# output with labels/annotations along with the number of images to sample
