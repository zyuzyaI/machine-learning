...
from worker.learning_rate_schedulers import StepDecay
from worker.learning_rate_schedulers import PolynomialDecay
from worker.resnet import ResNet
...
# then initialize the list of callbacks and learning rate scheduler to be used
epochs = args["epochs"]
callbacks = []
schedule = None 
...
# if the learning rate schedule is not empty, add it to the list of callbacks
...
# if we are using Keras' "standard" decay, then we need to set the decay parameter
